...
//
	...
	#elif defined(_DLL)
		#if defined(_DEBUG)
			#define POCO_LIB_SUFFIX "du.lib"
		#else
			#define POCO_LIB_SUFFIX "u.lib"
		#endif
	#else
		#if defined(_DEBUG)
			#define POCO_LIB_SUFFIX "MTdu.lib"
		#else
			#define POCO_LIB_SUFFIX "MTu.lib"
		#endif
	#endif

	#if !defined(POCO_NO_AUTOMATIC_LIBS) && !defined(Foundation_EXPORTS)
		#pragma comment(lib, "Poco.Foundation" POCO_LIB_SUFFIX)
	#endif
#endif
